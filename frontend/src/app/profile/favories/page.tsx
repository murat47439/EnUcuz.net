...
export default function favoritePage(){
    ...
    return (
        ...
        <h1 className="text-center font-bold mb-8 text-lg"> Favori Ürünlerim </h1>
        { products?.length >0 ?(
      ...
      ):(<p className="text-center border rounded-2xl mt-8 p-4">Henüz favorilere ürün yüklemediniz.</p>)
    }
    </main>
    )
}